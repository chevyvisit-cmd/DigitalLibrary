      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="space-y-4">
            <h1 
              style={{ color: '#22c55e' }}
              className="text-5xl md:text-6xl lg:text-7xl font-black leading-[1.1] tracking-tighter flex flex-wrap gap-x-[0.3em]"
            >
            ...
            <p className="text-[10px] text-[#22c55e] font-mono font-bold bg-[#22c55e]/10 px-2 py-1 rounded inline-block">DEPLOYED VERSION: 2.3-ULTRA</p>
            <motion.p
              variants={itemVariants}
